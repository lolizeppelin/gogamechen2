...
from gogamechen2.api import get_gamelock
from gogamechen2.models import AppEntity
from gogamechen2.models import ObjtypeFile
from gogamechen2.models import Package
from gogamechen2.models import PackageFile
from gogamechen2.models import PackageArea
from gogamechen2.models import PackageRemark
from gogamechen2.api.wsgi.game import GroupReuest
from gogamechen2.api.wsgi.caches import resource_cache_map
from gogamechen2.api.wsgi.caches import map_resources
from gogamechen2.api.wsgi.utils import gmurl
    ...
    def create(self, req, body=None):
        ...
        if not address:
            ...
            notify = {'success': dict(action='/files/%s' % md5,
                      ...
                      'fail': dict(action='/gogamechen2/objfiles/%s' % md5,
                                   method='DELETE')}
    ...
    def send(self, req, md5, body=None):
        ...
        if body.pop('all', True):
            ...
            if objtype is not None:
                includes.insert(0, 'metadata.gogamechen2-aff&%d' % common.APPAFFINITYS[objtype])
