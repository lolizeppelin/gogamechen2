...
from gogamechen2 import utils

from gogamechen2.api import gconfig
from gogamechen2.api import gfile
from gogamechen2.api.exceptions import MergeException
from gogamechen2.api.client import gogamechen2DBClient
from gogamechen2.api.rpc.config import gameserver_group
from gogamechen2.api.rpc.config import crossserver_group
from gogamechen2.api.rpc.config import gmserver_group
from gogamechen2.api.rpc.config import register_opts
from gogamechen2.api.rpc.config import agent_opts

from gogamechen2.api.rpc.taskflow import create as taskcreate
from gogamechen2.api.rpc.taskflow import upgrade as taskupgrade
from gogamechen2.api.rpc.taskflow import hotfix as taskhotfix
from gogamechen2.api.rpc.taskflow import merge as taskmerge
...
class Application(AppEndpointBase):
    ...
    def __init__(self, manager):
        ...
        self.client = gogamechen2DBClient(get_http())
        self.delete_tokens = {}
    ...
    def pre_start(self, external_objects):
        ...
        conf = CONF[common.NAME]
        external_objects.update({'gogamechen2-aff': conf.agent_affinity})
    ...
    def post_start(self):
        ...
        if self.entitys:
            ...
            if len(entitymaps) != len(self.entitys):
                raise RuntimeError('gogamechen2 entity count error, miss some entity')
